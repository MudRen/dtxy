...
me->set_temp("pass/random",pass);                          // waring del
 message("chat",HIC+"¡¼"+HIW+"´óÌÆÎ÷ÓÎ"+HIC+"¡½ÆÐÌá×æÊ¦(Master puti)£ºÎÒÍ½¶ù"+me->query("name")+"Îò³öÅÌÁú¾«Òª£¬½ñÈÕÑûÇë¸÷Î»ÏÉ¼ÒµÀÓÑÍ¬À´ÁéÌ¨¹ÛÀñ£¡\n\n"NOR,users());
...
void direct_panlong1(object me)
{
   ...
   if (me->query_temp("master/wzg"))
	...
	if (me->query_temp("master/hell"))
	{
       ...
       message("chat",HIC+"\n\n¡¼"+HIY+"´óÌÆÎ÷ÓÎ"+HIC+"¡½ÆÐÌá×æÊ¦¹þ¹þ´óÐ¦ÁË¼¸Éù¡£\n"NOR,users());
...
message("chat",HIC+"\n\n¡¼"+HIW+"¾ªÌìÒ¥´«"+HIC+"¡½Ä³ÈË£º"+ me->name()+"Í¨¹ýÁéÌ¨¹ÛÀñ¿¼Ñé£¬ÖÕÓÚÕÆÎÕÁË"+HIY"ÅÌÁú"+HIR"¾ø¼¼£¡\n"NOR,users());
	  // me->delete("fangcun");
   ...
   message("chat",HIC+"\n\n¡¼"+HIW+"¾ªÌìÒ¥´«"+HIC+"¡½Ä³ÈË£º"+ me->name()+"ËäÈ»Í¨¹ýÁéÌ¨¹ÛÀñ¿¼Ñé£¬¿ÉÏ§Ôµ·ÖÎ´µ½£¬ÖÕ²»ÄÜÕÆÎÕÁË"+HIY"ÅÌÁú"+HIR"¾ø¼¼£¡\n"NOR,users());
   present("master puti")->move("/d/lingtai/room");
