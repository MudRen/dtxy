...
void finish_qiansi()
{
	...
	message("chat",HIC+"\n\n〖"+HIW+"惊天谣传"+HIC+"〗千里眼(Qianli yan)：方寸山三星洞前有股灵气冲天而起,莫非又是那只猴子．．．．．．\n\n\n"NOR,users());
...
void finish_qiansi2()
{
	...
	message("chat",HIC+"\n\n〖"+HIY+"惊天谣传"+HIC+"〗菩提祖师「唉」的一声叹了口气。\n\n\n"NOR,users());
    message("chat",HIC+"〖"+HIW+"惊天谣传"+HIC+"〗菩提祖师(Master puti)：我徒儿"+me->query("name")+"缘分未及，终不能解千均棒法之神韵，可惜．．．可惜！\n\n"NOR,users());
...
void finish_qiansi13()
{
  object me;
  me=this_player();
   	message("chat",HIC+"\n\n〖"+HIY+"惊天谣传"+HIC+"〗菩提祖师对"+me->query("name")+"哈哈大笑了几声。\n\n"NOR,users());

	message("chat",HIC+"〖"+HIW+"惊天谣传"+HIC+"〗菩提祖师(Master puti)：乖徒儿"+me->query("name")+"这盘龙八式精要竟被你悟出，不过能不能掌握还要看你的
