...
string *list=({"yg-meihua","yg-jianmang","yg-jianzhang","yg-zxzx","yg-sanshou","yg-xueshan",
                "yg-ba","yg-jldl","yg-xiao","yg-yanluo","yg-kunlun","yg-sanban","yg-ningxie",
                "yg-flower","yg-shou","yg-xpt","yg-feixian","yg-bishou","yg-hammer",
	});
int reward_player ();
int recover_death ();
...
void informing (object me, object who)
{
  ...
  me->delete_temp("invite");
    if (who->query("lunhui_zhuanshi") > 0)
  	who->add("obstacle/rebirth",-3);
  message_vision ("\n$N对$n说：起身，可去宝阁取真经一本。\n",me,who);
