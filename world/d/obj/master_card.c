...
¡ù     È¡Ç®£º    ÃüÁî¸ñÊ½£ºcardwithdraw <ÊıÁ¿> <»õ±Òµ¥Î»>   ¡ù
¡ù     È¡Ç±ÄÜ£º  ÃüÁî¸ñÊ½£ºcardwithdraw <ÊıÁ¿> Ç±ÄÜ         ¡ù
¡ù     ´æÇ®£º    ÃüÁî¸ñÊ½£ºcarddeposit  <ÊıÁ¿> <»õ±Òµ¥Î»>   ¡ù
¡ù     ´æÇ±ÄÜ£º  ÃüÁî¸ñÊ½£ºcarddeposit  <ÊıÁ¿> Ç±ÄÜ¡£       ¡ù
¡ù     ²éÑ¯Óà¶î£ºÃüÁî¸ñÊ½£ºcardbalance                         ¡ù
¡ù     [0;1;37;34m´óÌÆÎ÷ÓÎµÄÍ¨ÓÃĞÅÓÃ¿¨£¬´ú±í×ÅÄãÔÚ±¾Õ¾µÄĞÅÓş¡£ [m        ¡ù
¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù¡ù
×¢Òâ: ´æÇ±ÄÜÊ±ÊÕÈ¡10%ÊÖĞø·Ñ
");
		set("value", 100);
   }
}
...
int do_deposit(string arg)
{
        ...
        {
			if (what == "gold-cash") {
				return notify_fail("½ğÆ±²»ÄÜÖ±½Ó´æµ½¿¨Àï\n");
			}
        if (what=="Ç±ÄÜ")
        {
        ...
        me->start_busy(1);
        msg = sprintf("$NÄÃ³ö%s%s%s£¬´æ½øÁË"HIY"´óÌÆ½ğÁú¿¨"NOR"¡£\n",
...
int do_withdraw(string arg)
{
        ...
        {
						if (what == "gold-cash") {
							return notify_fail("²»ÄÜ´Ó¿¨ÀïÈ¡½ğÆ±!\n");
						}
...
È¡Ç®£º  ÃüÁî¸ñÊ½£ºcardwithdraw <ÊıÁ¿> <»õ±Òµ¥Î»>
È¡Ç±ÄÜ£ºÃüÁî¸ñÊ½£ºcardwithdraw <ÊıÁ¿> Ç±ÄÜ
´æÇ®£º  ÃüÁî¸ñÊ½£ºcarddeposit  <ÊıÁ¿> <»õ±Òµ¥Î»>
´æÇ±ÄÜ£ºÃüÁî¸ñÊ½£ºcarddeposit  <ÊıÁ¿> Ç±ÄÜ
²éÑ¯Óà¶î£ºÃüÁî¸ñÊ½£ºcardbalance
HELP
    );
    return 1;
}
