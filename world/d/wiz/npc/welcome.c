...
// "新手多多help，如help news,help qj，help renwu！\n",
        "YWX人造人大唐西游主页地址是 http://rzrdtxy。5d6d。com/(请把句号换成小数点),欢迎访问！\n",
       "help news里面有关于MUD的最新变化！\n",
       "help rzr里面有关于人造人系统的介绍！\n",
//          "help rulaitask是取经之后的任务系统！\n",
//          "help zongshi里面介绍大唐西游各大门派宗师！\n",
//  "help newpfm里面有部分大唐特色perform的介绍！\n",
//"大唐西游主页提供在线查询功能（仅限安徽站），欢迎访问！\n",
//"请用top指令来查询目前在线玩家的排行，以及用topten指令来查看总排行\n",
//"大唐西游新增加一任务系统---炼丹，请help liandan查看详细信息。\n",
