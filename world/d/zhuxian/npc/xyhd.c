...
void create()
{
    ...
    set("mana_factor", 500);
    set_skill("seashentong", 351 );
    set_skill("dragonforce", 351 );
    set_skill("zixia-shengong", 351 );
    set_skill("taoism", 351 );
    set_skill("taoism", 351 );
    set_skill("butian-force", 351 );
    set_skill("mysticism", 351 );
    set_skill("baguazhou", 351 );
    set_skill("gouhunshu", 351 );
    set_skill("tonsillit", 351 );
    set_skill("spear", 321 );
...
int recognize_apprentice(object me)
{
      ...
      if (!(int)ob->query_temp("mark/人"))
        ...
        if( ( ob->query("family/family_name") != "将军府"
            ...
            && ob->query("family/family_name") != "三界散仙"
