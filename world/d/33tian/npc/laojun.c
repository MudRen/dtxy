...
string ask_wuxing()
{
	...
	command("say 好，我就送你一程，望你早日领会五行绝学。");
	message_vision(HIC "太上老君大袖一挥，你只觉四周景物飞快变化，一会到了一个完全陌生的地方！\n" NOR, me);
	me->move("/d/33tian/wuxing");
	message_vision(HIC "只听趴！地一声，从半空中掉下一个人来！\n" NOR, downroom);
	return ("我五庄观果然人才济济！");
}