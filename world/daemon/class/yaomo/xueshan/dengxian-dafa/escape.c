...
int cast(object me, object target)
{
	...
	if( me->is_fighting() || me->query("lunhui_zhuanshi") ) {
              if( (!me->is_fighting() && me->query("lunhui_zhuanshi")) || (random((int)me->query("max_mana")) > (int)target->query("max_mana")/2 && random((int)me->query("mana")) > (int)target->query("mana")/2 ) ) {
