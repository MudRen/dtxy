...
string jldl_result(object me, object victim, float mod_val, float force_adj, mapping action);
...
{   string result,str;
    ...
    mixed foo;
       ...
       if ( me_force*random(1000000)/1000000 < v_dodge*random(1000000)/1000000 )
