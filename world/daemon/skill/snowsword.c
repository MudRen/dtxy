...
HIW"$N手中$w"+HIW"再一抖，只见寒光点点，飘浮不定，罩向$n"+HIW"的$l"NOR,
        ...
        ([      "action":
HIW"$n只觉得一缕冷香掠过，$N已悄然间飘至$n身后，剑心直指$n"+HIW"的胸口"NOR,
                "dodge":                -30,
                "parry":                -35,
                "damage":               40,
                "force":               40,
...
HIW"$N一式「风波不信菱枝弱」，神色娴雅，蓄势待发，一道剑光澄如秋水、寒似玄冰"NOR,  
        ...
        ([      "action":
HIW"$N倾尽全力舞出「风回雪舞映雪魂」，娇喝中一道冰寒剑光冲天而起，夹着漫天风雪扑向$n"NOR,  
                "dodge":                -80,
                "parry":                -80,
                "damage":               80, 
                 "force":               80,
...
mapping query_action(object me, object weapon)
{
	...
	{
         	m_actions=me->query("skill_snowsword");
         	if( me->query("skill_snowsword") && random(3) && i < 7 ) return m_actions[random(sizeof(m_actions))];
         	return action[i];
