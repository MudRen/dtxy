...
string* skill_head =({
        "$N侧身一退，踏入左面的乾门，使出一招",
        "$N身形一晃，突然之间转到了坤门，反手一招",
        "$N连着几个旋身，自坎而离，过兑门入震门，脚下一点立在了艮门使出",
        "$N身形斜飞，落入坎门突然使出",
        "$N不退反进，扑入巽门之中一招",
        "$N脚下连踏八门，凝气攻出一招",
});
...
mapping *action = ({
   ...
   ([   "action":     "$N聚气凝元演化上清境，使出"+MAG"「紫气东来」"NOR+"$w带着淡紫色的剑芒向$n$l刺去",
     "dodge":     -50,
     "parry":     -50,
     "damage":     100,
     "damage_type":   "刺伤"
   ]),
   ([   "action":     "$N以始气演化玉清境，使出"+HIW"「天地同寿」"NOR+"$w带着银白色的剑芒向$n$l刺去",
     "dodge":     -50,
     "parry":     -50,
     "damage":     100,
     "damage_type":   "刺伤"
   ]),
   ([   "action":     "$N以玄气演化太清境，使出"+HIC"「天地玄黄」"NOR+"$w带着天青色的剑芒向$n$l刺去",
     "dodge":     -50,
     "parry":     -50,
     "damage":     100,
     "damage_type":   "刺伤"
