...
mapping *action1 = ({        
([      "action": "$N凝神含元，浑身透明，左手"+BLINK+HIW"冰魄刀"+NOR"一式"+HIW"『冰魄霜魂』"NOR+"，凌厉无比地击向$n",
        	"force":               400,
                "dodge":                -60,
                "parry":                -60,
                "damage_type":  "瘀伤"
        ]),
([      "action": "$N奋起全身之力，右手"+BLINK+HIR"火焰刀"+NOR"一招"+HIR"『焚心以火』"NOR+"，凌厉无比地击向$n",
                "force":               400,
                "dodge":                -60,
                "parry":                -60,
                "damage_type":  "瘀伤"
        ]),
([      "action" : "$N清啸一声，左手"+BLINK+HIW"「冰魄刀」"NOR+"，右手"+BLINK+HIR"「火焰刀」"NOR+"，两股截然不同的气劲击向$n",
                "force":               500,
                "dodge":                -80,
                "parry":                -80,
                "damage_type":  "瘀伤"
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
	...
	if( wizardp(me) ) tell_object(me,"");
        ...
        if( random(damage_bonus) > victim->query_str()/4 ) 
        {
               	...
               	if( i == 1 )
               		return HIC"$N寒劲一催，一道凛冽劲气击中$n的$l！\n"NOR;
               	if( i == 2 )
               		return HIR"$n的$l被$N催动的火焰刀烧得血肉模糊！\n"NOR;
               	if( i == 3 )
               		return HIG"$N左手冰魄刀，右手火焰刀，两道截然不同的内劲全在$n体内爆发！\n"NOR;
               	switch(random(3)) 
               	{
