...
([
"action" : 
RED"$N左手拨动琴弦，抚弄一曲，名曰："+HIG"「风入松」"+NOR+RED"，音韵幽扬，如万壑松涛，右手$w"+RED"合着琴韵刺向$n"NOR+xue_name[random(sizeof(xue_name))],
"parry_msg" :
...
([
"action" : 
RED"$N拨动琴弦，一曲"+NOR+HIM"「花满楼」"+NOR+RED"，$w"+RED"随琴声满天飞舞，但听铮一声响，漫天剑气同时刺向$n"NOR+xue_name[random(sizeof(xue_name))],
"parry_msg" :
"$n$w往来穿梭,破空之音竟似一曲"+HIM"「梅花三弄」"+NOR"，将$N的招式一一截住。",
"parry_power":		10,
"dodge"  : -60,
"parry" : -60,
"force" : 80,
...
([
"action" : 
RED"只听音韵真如戛玉鸣球，清婉欲绝，一曲"+NOR+HIW"「寒江雪」"+NOR+RED"今$n尘襟顿爽，突然$w"+RED"划破琴音破空刺向$n"NOR+xue_name[random(sizeof(xue_name))],
"parry_power":		10,
"parry_msg" :
...
([
"action" : 
RED"$N手姿俊雅，一曲"+NOR+HIC"「月牙泉」"+NOR+RED"，琴音叮叮咚咚，妙不可言。$n只听得神荡意迷，如醉如痴，不觉$w"+RED"已悄然刺向"NOR+xue_name[random(sizeof(xue_name))],
"parry_power":		10,
"parry_msg" :
"$n抚弄一曲"+HIC"「三潭映月」"+NOR"，朱唇轻启，随曲唱道：杨柳依依弄晚风，桃花半吐映日红；芳草绵绵铺锦绣，任他车马各西东。$N听得入神招式一滞，被$w"+NOR"一一化解。",
"dodge"  : -80,
"parry" : -80,
"force" : 100,
"force" : 100,
