...
ÇëÄú¸ø×Ô¼ºÏëÒ»¸ö·ûºÏ¡¼´óÌÆÎ÷ÓÎ¡½Éñ»°ÊÀ½çµÄÖĞÎÄÃû×Ö¡£Õâ
¸öÃû×Ö½«´ú±íÄãÔÚ´óÌÆÎ÷ÓÎÖĞµÄÈËÎï£¬¶øÇÒÍùºó½«²»ÄÜÔÙ¸ü¸Ä¡£
	...
	"/adm/daemons/toptend"->topten_checkplayer(user);
		...
		tell_room(startroom, user->query("name") + "Á¬Ïß½øÈëÕâ¸öÊÀ½ç¡£\n",
   		...
   		if(file_size("/log/notice")>0){
			write(CYN"     ¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô"HIR"´óÌÆÎ÷ÓÎÁ¬ÏßÍ¨Öª"NOR CYN"¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô\n");
