		...
		else 
		{
			if(ob->query_temp("rulaitask/fight_time"))
		        { 
		        	...
		        	message_vision(CYN"$N说道：我现在方知天外有天，人外有人，我还要回山多多修炼，告辞了。\n"NOR,me);
	 ...
	 if ( guai_eff_kee*100/guai_max_kee < 15 )
	      {
	      	...
	      	message_vision(CYN"$N说道：你说的有道理，我这就回山去。\n"NOR,ob);
	   ...
	   else if ( guai_eff_kee*100/guai_max_kee < 20 )
	        {
	        	...
	        	message_vision(CYN"$N说道：你看我现在，不比做佛快乐吗。\n"NOR,ob);
