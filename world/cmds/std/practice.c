...
int main(object me, string arg)
{
	...
	skill_power=0.0+skill;
 	skill_power= skill_power*skill_power*skill_power/10;
	if( skill_power > (int)me->query("combat_exp") )
	...
	if( SKILL_D(skillname)->practice_skill(me) ) {
                me->improve_skill(skillname, (skill_basic/2 +1)*(1+random(me->query_int() * me->query_int() / 100)),
